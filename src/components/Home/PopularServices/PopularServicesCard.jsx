...
const PopularServicesCard = ({servics}) => {
	...
	<div className="flex space-x-4">
		<img alt="" src={provider.photo} className="object-cover w-12 h-12 rounded-full shadow dark:bg-gray-500" />
		<div className="flex flex-col space-y-1">
			<a rel="noopener noreferrer" href='https://www.linkedin.com/in/al-taj1/' className="text-sm font-semibold">{provider.
name
}</a>
